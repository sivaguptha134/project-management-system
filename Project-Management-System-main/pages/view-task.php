...
<body>
  ...
  <footer id="footer">
    <div id="slideContainer">
      <div id="slide1">
        ...
        <div id="socialBtnContainer">
          ...
          <a href="https://www.linkedin.com/in/yenduri-siva-ganagadhara-guptha-3baba7269/"><i class="fa-brands fa-linkedin"></i></a>
        </div>
    ...
    <div id="developed">developed by @SIVA GANGADHARA GUPTHA YENDURI </div>
  </footer>
</body>
